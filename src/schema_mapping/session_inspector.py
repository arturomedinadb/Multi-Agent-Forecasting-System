...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print(
            "  python -m mapping_system.schema_mapping.tools.session_inspector inspect <session_id>"
        )
        print(
            "  python -m mapping_system.schema_mapping.tools.session_inspector inspect <session_id> --verbose"
        )
        sys.exit(1)
